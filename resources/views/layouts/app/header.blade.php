            ...
            <div class="text-end">
                ...
                @else
                    <div class="dropdown-center">
                        <button class="btn btn-outline-dark text-light dropdown-toggle" type="button"
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                <a class="dropdown-item" href="#"><i class="fa-solid fa-user"></i> {{ Auth::user()->email }}</a>
                            </li>
                            @if (Auth::user()->role == 'admin')
                                <li>
                                    <a class="dropdown-item" href="{{ route('post') }}"><i class="fa-solid fa-lock"></i>
                                        Admin Panel </a>
                                </li>
                            @endif
